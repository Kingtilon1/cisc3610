...
let player, ball, brownBricks, orangeBricks, pinkBricks, cursors;
...
function create() {
  ...
  // Add brown bricks
  brownBricks = this.physics.add.group({
    key: 'brick1',
    repeat: 9,
    immovable: true,
    setXY: {
  ...
  this.physics.add.collider(ball, brownBricks, hitBrick, null, this);
 ...
 */
function isWon() {
  return brownBricks.countActive() + orangeBricks.countActive() + redBricks.countActive() == 0;
}

/**
 * This function handles the collision between a ball and a brick sprite
 * In the create function, ball is a sprite and brownBricks, orangeBricks and
